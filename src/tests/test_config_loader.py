...
assert config.safety.leader_pose_planned_fallback_enabled is True
assert config.safety.leader_pose_planned_fallback_ids == [7]
assert config.safety.leader_pose_planned_fallback_stale_after_s == 0.18
assert config.safety.leader_pose_planned_fallback_max_age_s == 0.8
...
assert config.safety.runtime_pose_speed_min_dt == 0.03
assert config.safety.runtime_pose_speed_min_jump == 0.08
